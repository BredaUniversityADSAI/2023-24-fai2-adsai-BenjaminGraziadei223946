...
class Simulation:
    def __init__(self, num_agents, render=True, rgb_array=False):
        ...
        self.textureId = p.loadTexture(r"C:\Users\benjm\Documents\GitHub\2023-24-fai2-adsai-BenjaminGraziadei223946\3. Reinforcement Learning\uvmapped_dish_large_comp.png")
        ...
        for i in range(grid_size):
            for j in range(grid_size):
                if agent_count < num_agents:  # Check if more agents need to be placed
                    ...
                    robotId = p.loadURDF(r"C:\Users\benjm\Documents\GitHub\2023-24-fai2-adsai-BenjaminGraziadei223946\3. Reinforcement Learning\ot_2_simulation_v6.urdf", position, [0,0,0,1],
                    ...
                    planeId = p.loadURDF(r"C:\Users\benjm\Documents\GitHub\2023-24-fai2-adsai-BenjaminGraziadei223946\3. Reinforcement Learning\custom.urdf", position_with_offset, rotate_90)#start_orientation)
